...
### 2.3 Monthly AI Cost by User Behavior
...
### 6.3 Ambassador Earning Scenarios

#### Ethiopian Tour Guide — Year 1 Projections
...
#### Power Ambassador — Building a Network
...
| Cookie duration | 30 days (signup attribution) |
| Lifetime attribution | Conversions tracked forever after signup |
...
### 7.2 Regional Pricing Protection
...
### 7.3 Ambassador Fraud Prevention

| Risk | Mitigation |
|------|------------|
| Self-referrals | Email/IP matching, manual review |
| Fake signups | Require subscription for commission |
| Commission gaming | 30-day chargeback clawback |
| Inactive ambassadors | Auto-pause after 90 days no activity |

---

### 7.4 Extreme Usage Economics
...
### Phase 4: Usage Limits — Priority 🟡

- [ ] Add `subscriptionTier` field to user record
- [ ] Create tier-based limit configuration
- [ ] Implement daily cap checking per feature
- [ ] Add limit reset job (midnight UTC)
- [ ] Build "limit reached" UI messaging

---

### Phase 5: Ambassador 2-Level System — Priority 🟡

- [ ] Add `recruitedBy` field to ambassadors table
- [ ] Update commission calculation for Tier 2
- [ ] Build recruiter dashboard showing downstream earnings
- [ ] Implement monthly payout calculation
- [ ] Create payout reporting for accounting

---

### Phase 6: Monitoring & Analytics — Priority 🟢

- [ ] Track profit per user (revenue - costs)
- [ ] Monitor usage patterns by tier
- [ ] Flag users approaching limits
