      ...
      <section className="bg-white" style={{ paddingTop: '65px', paddingBottom: '10px' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-row gap-4 justify-center">
            <a href="https://apps.apple.com/us/app/vagabond-bible/id6757680520" rel="noopener noreferrer" onClick={(e) => { window.gtag?.('event', 'click_app_store'); const isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent); if (isMobile) { e.preventDefault(); window.location.href = 'https://apps.apple.com/us/app/vagabond-bible/id6757680520'; } }} target={/iPhone|iPad|iPod|Android/i.test(typeof navigator !== 'undefined' ? navigator.userAgent : '') ? undefined : '_blank'} className="inline-flex items-center gap-2.5 bg-black hover:bg-black/80 text-white pl-3 pr-4 py-2 rounded-lg transition-all duration-200 md:hover:scale-105 active:scale-95 transform-gpu" data-testid="link-app-store">
