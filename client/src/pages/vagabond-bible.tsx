...
import vagabondLogoWhite from "@assets/vagabond-just-vagabond-logo-white_1778490033326.png";
      ...
      <div className="min-h-screen bg-black">
        <section className="relative min-h-[100svh] flex items-center justify-center">
          ...
          >
            <div className="max-w-md mx-auto text-center">
              <h1 className={`font-heading mb-4 text-white font-extrabold leading-[1.12] ${isAmharic ? 'text-[28px] sm:text-4xl' : 'text-[36px] sm:text-5xl'}`}>
                {t("landing.hero_title_1")} <span className="text-[hsl(35,65%,55%)]">{t("landing.hero_title_2")}</span><br /><span className="text-[hsl(35,65%,55%)]">{t("landing.hero_title_3")}</span>
              </h1>
          ...
          >
            ...
            <img src={vagabondLogoWhite} alt="Vagabond" className="h-8 mx-4" />
            <div className="flex-1 h-px bg-gray-400/15" />
          </div>
        </section>
      </div>
      ...
      <section className="bg-white" style={{ paddingTop: '65px', paddingBottom: '10px' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-row gap-4 justify-center">
            <a href="https://apps.apple.com/us/app/vagabond-bible/id6757680520" rel="noopener noreferrer" onClick={(e) => { window.gtag?.('event', 'click_download_app', { platform: 'ios' }); const isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent); if (isMobile) { e.preventDefault(); window.location.href = 'https://apps.apple.com/us/app/vagabond-bible/id6757680520'; } }} target={/iPhone|iPad|iPod|Android/i.test(typeof navigator !== 'undefined' ? navigator.userAgent : '') ? undefined : '_blank'} className="inline-flex items-center gap-2.5 bg-black hover:bg-black/80 text-white pl-3 pr-4 py-2 rounded-lg transition-all duration-200 md:hover:scale-105 active:scale-95 transform-gpu" data-testid="link-app-store">
            ...
            <a 
              ...
              onClick={() => {
                window.gtag?.('event', 'click_download_app', { platform: 'android' });
              }}
      ...
      <footer id="contact" className="py-16 bg-[hsl(30,20%,97%)] border-t border-[hsl(30,20%,88%)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-12">
            <div>
              <img src={vagabondLogo} alt="Vagabond" className="h-10 mb-4" />
              <p className="text-[hsl(20,10%,40%)] leading-relaxed">
