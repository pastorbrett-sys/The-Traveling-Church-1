...
export default function FindAService() {
  ...
  return (
    <div className="bg-background text-foreground antialiased min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-secondary/10 py-1 md:py-24">
      ...
      <section id="services" className="py-16 md:py-24 bg-muted/50 scroll-mt-20 -mt-[175px] md:-mt-[100px] relative z-10">
