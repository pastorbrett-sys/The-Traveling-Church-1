...
export default function DeleteAccount() {
  ...
  useEffect(() => {
    document.title = `Delete Account | ${brandName}`;
  }, [brandName]);
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none text-[hsl(20,10%,30%)]">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              You can delete your {brandName} account directly from within the app by following these steps:
            </p>
            <ol className="list-decimal list-inside space-y-3 mb-4 ml-2">
              <li className="text-[hsl(20,10%,30%)]">Open the {brandName} app</li>
