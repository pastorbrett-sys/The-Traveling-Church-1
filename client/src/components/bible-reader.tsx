  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <Dialog open={showCompare} onOpenChange={setShowCompare}>
        <DialogContent className="!max-w-none !w-full !h-full !left-0 !top-0 !translate-x-0 !translate-y-0 !rounded-none sm:!left-[50%] sm:!top-[50%] sm:!translate-x-[-50%] sm:!translate-y-[-50%] sm:!max-w-2xl sm:!w-[95vw] sm:!h-auto sm:!max-h-[80vh] sm:!rounded-lg overflow-hidden flex flex-col p-0 sm:p-6">
