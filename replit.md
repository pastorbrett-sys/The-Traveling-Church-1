...
- **Prayer Timer**: Background meditation music with crossfade between tracks. Features:
  - **Lock Screen Controls**: iOS/Android lock screen displays track info, artwork ("Music by Pastor Brett"), and play/pause controls via `capacitor-music-controls-plugin@6.1.0` (includes Android 14+ RECEIVER_NOT_EXPORTED fix).
